...
from .views import ApplicationCreateView, ApplicationUpdateView, ApplicationDestroyView, ApplicationRetrieveView, \
    ApplicationListView, ApplicationListFreelancerView
...
urlpatterns = [
    ...
    path('application/retrieve/<int:pk>/', ApplicationRetrieveView.as_view()),
    path('application/list/<int:project_id>/', ApplicationListView.as_view()),
    path('application/listfreelancer/<int:freelancer_id>/', ApplicationListFreelancerView.as_view()),
    path('application/create/', ApplicationCreateView.as_view()),
